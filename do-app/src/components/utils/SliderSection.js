...
const SliderSection = () => {
  const { books, fieldState,  setSelectedSection, setSelectedSubsection } = useContext(BooksContext);
        ...
        {uniqueSections.map((section, index) => (        
            <div key={index} className="slider-item" onClick={() => handleSectionClick(section)}>
              <img 
                ...
                alt="Section Icon" 
                onError={(e) => e.target.src = burger} // Если изображение не загрузится, заменяем на burger
              />
